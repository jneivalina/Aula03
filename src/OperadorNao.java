...
public class OperadorNao {
	...
	public static void main(String[] args) {
		...
		if (!tipoUsuario.equals("administrador")) {
			System.out.println("Atenção, usuário sem poderes administrativos, Algumas funcionalidades serão restritas");
		}else {
			System.out.println("usuário com poderes administrativos. Fique atento as alterações realizadas!");
		}
